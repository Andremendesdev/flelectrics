      ...
      {features.map(({ icon: Icon, title, subtitle }) => (
        ...
        >
          <div className="relative flex items-center justify-center w-11 h-11 md:w-14 md:h-14 mb-2 md:mb-3">
            <div className="absolute inset-0 rounded-full bg-sky-400/15 blur-lg scale-125" />
            <div className="absolute inset-1 rounded-full border border-sky-400/20" />
            <Icon
              className="relative w-5 h-5 md:w-7 md:h-7 text-sky-400 drop-shadow-[0_0_10px_rgba(56,189,248,0.85)]"
              strokeWidth={1.5}
            />
          </div>
          ...
          <p className="text-[8px] sm:text-[9px] md:text-[10px] tracking-[0.12em] text-sky-400/80 uppercase leading-snug mt-0.5">
            {subtitle}
          </p>
        </motion.div>
      ))}
