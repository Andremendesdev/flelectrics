    ...
    <section className="relative min-h-[85svh] md:min-h-[921px] flex items-center pt-28 pb-16 md:pt-margin-desktop md:pb-margin-desktop px-gutter md:px-margin-desktop overflow-hidden -mt-20">
      <div className="absolute inset-0 z-0 bg-surface-container-lowest">
        <motion.img
          ...
          src="/fundo.png"
          alt=""
          className="w-full h-full object-cover object-[center_64%]"
          aria-hidden="true"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-background via-background/80 to-transparent"></div>
        <FloatingParticles count={10} opacityScale={0.55} className="z-[1]" />
      </div>
      ...
      <div className="relative z-10 max-w-container-max mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-margin-desktop items-center">
        ...
        >
          ...
          >
            ...
            <a
              href="#models"
              className="btn-border-trail group w-full sm:w-auto flex justify-center hover:scale-[1.02] active:scale-[0.98] transition-transform duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-full"
            >
              <span className="relative z-10 inline-flex items-center justify-center gap-base font-label-md text-label-md bg-transparent text-blue-600 rounded-full px-8 py-4 w-full sm:w-auto group-hover:text-sky-400 transition-colors duration-300">
                Ver Modelos
