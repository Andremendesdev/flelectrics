  ...
  return (
    <div ref={ref} className={cn("relative w-fit max-w-full", className)}>
      ...
      <motion.span
        ...
        className="absolute left-0 -bottom-1 sm:-bottom-1.5 h-[2px] sm:h-[2.5px] w-full origin-left rounded-full bg-gradient-to-r from-blue-600 via-sky-400 to-blue-500 shadow-[0_0_8px_rgba(56,189,248,0.45)]"
        aria-hidden="true"
      />
    </div>
  );
