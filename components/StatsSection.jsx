    ...
    <section className="relative py-14 sm:py-20 md:py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-4 sm:px-gutter md:px-margin-desktop">
        <ScrollReveal className="text-center mb-8 sm:mb-12 md:mb-14">
          <p className="text-[9px] sm:text-[10px] font-medium tracking-[0.2em] uppercase text-sky-400 mb-2 sm:mb-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
          {stats.map((stat, i) => (
            <ScrollReveal key={stat.label} delay={i * 0.08}>
              <div className="glass-panel rounded-lg sm:rounded-xl p-3.5 sm:p-5 md:p-7 lg:p-8 text-center group hover:border-sky-400/20 transition-colors duration-500 h-full flex flex-col justify-center min-w-0">
